...
namespace rc {
    ...
    int MyCobot::InitSerialPort()
    {
        ...
        if (serial_port == nullptr)
            serial_port = new QSerialPort(nullptr);
        ...
        serial_port->setBaudRate(1000000);                       // use the int overload
        ...
        serial_timer = new QTimer(nullptr);
    ...
    */
    ...
    void MyCobot::CommandThreadWorker()
    {
        ...
        while (command_thread_running) {
            ...
            if (f.first == Command::JogStop || f.first == Command::GetAngles || f.first == Command::GetEncoders || f.first == Command::GetCoords) {
